        ...
        {searchInput && (
          <div className='flex flex-col col-span-3 mx-auto mt-2 '>
            ...
            <div className='flex'>
              <button 
              onClick={()=>resetInput()}
              className='flex-grow text-gray-500 hover:text-black hover:text-bold'>Cancel</button>
              <button onClick={()=>search()} className='flex-grow text-red-400 hover:text-red-600 hover:text-bold'>Search</button>
              </div>
          </div>
        )}
